...
/** Minimal subset of the Umami browser API used by this app. */
interface Umami {
 ...
 */
const sanitizeEventData = (data: Record<string, unknown>): Record<string, unknown> => {
 ...
 *
 * @param eventName - Name of the event (kebab-case)
